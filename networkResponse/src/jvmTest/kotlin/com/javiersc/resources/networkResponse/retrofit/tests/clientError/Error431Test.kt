...
internal class Error431Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> =
        StatusCode.REQUEST_HEADER_FIELDS_TOO_LARGE_431 to "4xx.json"
...
internal class ErrorNull431Test :
    BaseNullTest<ErrorDTO?>(StatusCode.REQUEST_HEADER_FIELDS_TOO_LARGE_431) {
