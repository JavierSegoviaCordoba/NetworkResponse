...
internal class Error411Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> = StatusCode.LENGTH_REQUIRED_411 to "4xx.json"
...
internal class ErrorNull411Test : BaseNullTest<ErrorDTO?>(StatusCode.LENGTH_REQUIRED_411) {
