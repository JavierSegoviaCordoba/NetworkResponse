...
internal class Error421Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> = StatusCode.MISDIRECTED_REQUEST_421 to "4xx.json"
...
internal class ErrorNull421Test : BaseNullTest<ErrorDTO?>(StatusCode.MISDIRECTED_REQUEST_421) {
