...
internal class Error502Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> = StatusCode.BAD_GATEWAY_502 to "5xx.json"
...
internal class ErrorNull502Test : BaseNullTest<ErrorDTO?>(StatusCode.BAD_GATEWAY_502) {
