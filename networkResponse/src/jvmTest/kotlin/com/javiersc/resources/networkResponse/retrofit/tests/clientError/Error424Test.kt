...
internal class Error424Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> = StatusCode.FAILED_DEPENDENCY_424 to "4xx.json"
...
internal class ErrorNull424Test : BaseNullTest<ErrorDTO?>(StatusCode.URI_TOO_LONG_414) {
