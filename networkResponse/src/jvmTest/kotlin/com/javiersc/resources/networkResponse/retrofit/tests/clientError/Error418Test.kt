...
internal class Error418Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> = StatusCode.IM_A_TEAPOT_418 to "4xx.json"
...
internal class ErrorNull418Test : BaseNullTest<ErrorDTO?>(StatusCode.IM_A_TEAPOT_418) {
