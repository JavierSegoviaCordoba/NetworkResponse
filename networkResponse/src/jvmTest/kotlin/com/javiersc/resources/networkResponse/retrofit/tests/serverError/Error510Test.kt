...
internal class Error510Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> = StatusCode.NOT_EXTENDED_510 to "5xx.json"
...
internal class ErrorNull510Test : BaseNullTest<ErrorDTO?>(StatusCode.NOT_EXTENDED_510) {
