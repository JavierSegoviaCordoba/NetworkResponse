...
internal class Error404Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> = StatusCode.NOT_FOUND_404 to "4xx.json"
...
internal class ErrorNull404Test : BaseNullTest<ErrorDTO?>(StatusCode.NOT_FOUND_404) {
