...
internal class Error426Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> = StatusCode.UPGRADE_REQUIRED_426 to "4xx.json"
...
internal class ErrorNull426Test : BaseNullTest<ErrorDTO?>(StatusCode.UPGRADE_REQUIRED_426) {
