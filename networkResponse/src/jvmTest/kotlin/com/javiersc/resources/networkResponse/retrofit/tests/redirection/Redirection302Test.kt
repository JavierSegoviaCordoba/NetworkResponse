...
internal class Error302Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> = StatusCode.FOUND_302 to null
...
internal class ErrorNull302Test : BaseNullTest<ErrorDTO?>(StatusCode.FOUND_302) {
