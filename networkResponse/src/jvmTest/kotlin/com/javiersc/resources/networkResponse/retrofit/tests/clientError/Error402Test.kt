...
internal class Error402Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> = StatusCode.PAYMENT_REQUIRED_402 to "4xx.json"
...
internal class ErrorNull402Test : BaseNullTest<ErrorDTO?>(StatusCode.PAYMENT_REQUIRED_402) {
