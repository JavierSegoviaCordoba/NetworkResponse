...
internal class Error406Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> = StatusCode.NOT_ACCEPTABLE_406 to "4xx.json"
...
internal class ErrorNull406Test : BaseNullTest<ErrorDTO?>(StatusCode.NOT_ACCEPTABLE_406) {
