...
internal class Error505Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> =
        StatusCode.HTTP_VERSION_NOT_SUPPORTED_505 to "5xx.json"
...
internal class ErrorNull505Test :
    BaseNullTest<ErrorDTO?>(StatusCode.HTTP_VERSION_NOT_SUPPORTED_505) {
