...
internal class Error401Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> = StatusCode.UNAUTHORIZED_401 to "4xx.json"
...
internal class ErrorNull401Test : BaseNullTest<ErrorDTO?>(StatusCode.UNAUTHORIZED_401) {
