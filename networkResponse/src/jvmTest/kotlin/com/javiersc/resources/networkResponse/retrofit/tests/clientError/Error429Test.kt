...
internal class Error429Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> = StatusCode.TOO_MANY_REQUEST_429 to "4xx.json"
...
internal class ErrorNull429Test : BaseNullTest<ErrorDTO?>(StatusCode.TOO_MANY_REQUEST_429) {
