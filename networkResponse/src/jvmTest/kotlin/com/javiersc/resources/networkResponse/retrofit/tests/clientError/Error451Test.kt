...
internal class Error451Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> =
        StatusCode.UNAVAILABLE_FOR_LEGAL_REASONS_451 to "4xx.json"
...
internal class ErrorNull451Test :
    BaseNullTest<ErrorDTO?>(StatusCode.UNAVAILABLE_FOR_LEGAL_REASONS_451) {
