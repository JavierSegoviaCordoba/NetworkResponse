...
internal class Error416Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> =
        StatusCode.REQUESTED_RANGE_NOT_SATISFIABLE_416 to "4xx.json"
...
internal class ErrorNull416Test :
    BaseNullTest<ErrorDTO?>(StatusCode.REQUESTED_RANGE_NOT_SATISFIABLE_416) {
