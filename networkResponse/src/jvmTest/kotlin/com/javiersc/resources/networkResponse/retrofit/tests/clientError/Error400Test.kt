...
internal class Error400Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> = StatusCode.BAD_REQUEST_400 to "4xx.json"
...
internal class ErrorNull400Test : BaseNullTest<ErrorDTO?>(StatusCode.BAD_REQUEST_400) {
