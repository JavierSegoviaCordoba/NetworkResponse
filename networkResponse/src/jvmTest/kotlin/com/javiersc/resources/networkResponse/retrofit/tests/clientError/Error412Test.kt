...
internal class Error412Test : BaseTest<ErrorDTO>() {
    ...
    override val codeToFile: Pair<Int, String?> = StatusCode.PRECONDITION_FAILED_412 to "4xx.json"
...
internal class ErrorNull412Test : BaseNullTest<ErrorDTO?>(StatusCode.PRECONDITION_FAILED_412) {
