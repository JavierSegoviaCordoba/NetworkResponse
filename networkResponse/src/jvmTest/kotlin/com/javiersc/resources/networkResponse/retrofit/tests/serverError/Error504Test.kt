...
internal class Error504Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> = StatusCode.GATEWAY_TIMEOUT_504 to "5xx.json"
...
internal class ErrorNull504Test : BaseNullTest<ErrorDTO?>(StatusCode.GATEWAY_TIMEOUT_504) {
