...
internal class Error304Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> = StatusCode.NOT_MODIFIED_304 to null
...
internal class ErrorNull304Test : BaseNullTest<ErrorDTO?>(StatusCode.NOT_MODIFIED_304) {
