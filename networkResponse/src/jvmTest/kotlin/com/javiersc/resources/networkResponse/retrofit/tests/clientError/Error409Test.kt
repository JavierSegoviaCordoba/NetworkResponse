...
internal class Error409Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> = StatusCode.CONFLICT_409 to "4xx.json"
...
internal class ErrorNull409Test : BaseNullTest<ErrorDTO?>(StatusCode.CONFLICT_409) {
