...
internal class Error511Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> =
        StatusCode.NETWORK_AUTHENTICATION_REQUIRED_511 to "5xx.json"
...
internal class ErrorNull511Test :
    BaseNullTest<ErrorDTO?>(StatusCode.NETWORK_AUTHENTICATION_REQUIRED_511) {
