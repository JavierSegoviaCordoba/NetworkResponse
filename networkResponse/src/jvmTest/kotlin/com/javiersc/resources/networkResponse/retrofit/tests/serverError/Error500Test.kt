...
internal class Error500Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> = StatusCode.INTERNAL_SERVER_ERROR_500 to "5xx.json"
...
internal class ErrorNull500Test : BaseNullTest<ErrorDTO?>(StatusCode.INTERNAL_SERVER_ERROR_500) {
