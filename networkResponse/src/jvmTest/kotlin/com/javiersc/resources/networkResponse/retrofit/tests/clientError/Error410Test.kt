...
internal class Error410Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> = StatusCode.GONE_410 to "4xx.json"
...
internal class ErrorNull410Test : BaseNullTest<ErrorDTO?>(StatusCode.GONE_410) {
