...
internal class Error428Test : BaseTest<ErrorDTO>() {
    ...
    override val codeToFile: Pair<Int, String?> = StatusCode.PRECONDITION_REQUIRED_428 to "4xx.json"
...
internal class ErrorNull428Test : BaseNullTest<ErrorDTO?>(StatusCode.PRECONDITION_REQUIRED_428) {
