...
internal class Error413Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> = StatusCode.PAYLOAD_TOO_LARGE_413 to "4xx.json"
...
internal class ErrorNull413Test : BaseNullTest<ErrorDTO?>(StatusCode.PAYLOAD_TOO_LARGE_413) {
