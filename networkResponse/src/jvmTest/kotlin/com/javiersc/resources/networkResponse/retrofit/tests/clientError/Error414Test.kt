...
internal class Error414Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> = StatusCode.URI_TOO_LONG_414 to "4xx.json"
...
internal class ErrorNull414Test : BaseNullTest<ErrorDTO?>(StatusCode.URI_TOO_LONG_414) {
