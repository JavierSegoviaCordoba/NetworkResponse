...
internal class Error507Test : BaseTest<ErrorDTO>() {
    ...
    override val codeToFile: Pair<Int, String?> = StatusCode.INSUFFICIENT_STORAGE_507 to "5xx.json"
...
internal class ErrorNull507Test : BaseNullTest<ErrorDTO?>(StatusCode.INSUFFICIENT_STORAGE_507) {
