...
internal class Error508Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> = StatusCode.LOOP_DETECTED_508 to "5xx.json"
...
internal class ErrorNull508Test : BaseNullTest<ErrorDTO?>(StatusCode.LOOP_DETECTED_508) {
