...
internal class Error405Test : BaseTest<ErrorDTO>() {

    override val codeToFile: Pair<Int, String?> = StatusCode.METHOD_NOT_ALLOWED_405 to "4xx.json"
...
internal class ErrorNull405Test : BaseNullTest<ErrorDTO?>(StatusCode.METHOD_NOT_ALLOWED_405) {
