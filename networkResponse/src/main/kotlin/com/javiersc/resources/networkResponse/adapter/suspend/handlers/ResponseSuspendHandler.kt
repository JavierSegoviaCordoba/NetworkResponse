...
internal fun <R : Any, E : Any> Response<R>.responseSuspendHandler(
    ...
    when {
        body == null && code in 200..299 -> callback.onResponse(call, success(NoContent(headers)))
        body != null && code in 200..299 -> handle2xx(call, callback, code, body, headers)
        code in 100..599 -> handleAllNoSuccess(call, callback, code, errorBody, headers)
